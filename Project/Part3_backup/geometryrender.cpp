...
void GeometryRender::applyTexture(){
    ...
    QImage image("/home/oi12/oi12mnd/Desktop/CG/Project/build-project-Desktop-Debug/bricks.bmp");
...
void GeometryRender::loadGeometry(){
    ...
    size_t texSize = texCoords.size()*sizeof(float)*2;
