...
QT_MOC_LITERAL(4, 40, 18) // "notifyValueChanged"

    },
    "QDoubleSlider\0doubleValueChanged\0\0"
    "value\0notifyValueChanged"
};
...
void QDoubleSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QDoubleSlider::doubleValueChanged)) {
                *result = 0;
                return;
            }
        }
