...
const QMetaObject LightSource::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LightSource.data,
      qt_meta_data_LightSource,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
